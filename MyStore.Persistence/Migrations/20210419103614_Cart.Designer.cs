            ...
            modelBuilder.Entity("MyStore.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2021, 4, 19, 15, 6, 12, 496, DateTimeKind.Local).AddTicks(506),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2021, 4, 19, 15, 6, 12, 501, DateTimeKind.Local).AddTicks(1243),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2021, 4, 19, 15, 6, 12, 501, DateTimeKind.Local).AddTicks(1436),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
