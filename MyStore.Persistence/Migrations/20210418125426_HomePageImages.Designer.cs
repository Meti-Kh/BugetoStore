...
namespace MyStore.Persistence.Migrations
{
    ...
    [Migration("20210418125426_HomePageImages")]
            ...
            modelBuilder.Entity("MyStore.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2021, 4, 18, 17, 24, 25, 786, DateTimeKind.Local).AddTicks(6286),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2021, 4, 18, 17, 24, 25, 792, DateTimeKind.Local).AddTicks(1385),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2021, 4, 18, 17, 24, 25, 792, DateTimeKind.Local).AddTicks(1614),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
