            ...
            modelBuilder.Entity("MyStore.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2021, 4, 20, 14, 22, 12, 433, DateTimeKind.Local).AddTicks(8693),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2021, 4, 20, 14, 22, 12, 438, DateTimeKind.Local).AddTicks(8619),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2021, 4, 20, 14, 22, 12, 438, DateTimeKind.Local).AddTicks(8816),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
