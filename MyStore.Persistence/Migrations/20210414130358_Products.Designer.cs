...
namespace MyStore.Persistence.Migrations
{
    ...
    [Migration("20210414130358_Products")]
            ...
            modelBuilder.Entity("MyStore.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2021, 4, 14, 17, 33, 56, 347, DateTimeKind.Local).AddTicks(5847),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2021, 4, 14, 17, 33, 56, 352, DateTimeKind.Local).AddTicks(7297),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2021, 4, 14, 17, 33, 56, 352, DateTimeKind.Local).AddTicks(7497),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
