...
namespace MyStore.Persistence.Migrations
{
    ...
    [Migration("20210417113214_ViewCount")]
            ...
            modelBuilder.Entity("MyStore.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2021, 4, 17, 16, 2, 12, 823, DateTimeKind.Local).AddTicks(2577),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2021, 4, 17, 16, 2, 12, 856, DateTimeKind.Local).AddTicks(8428),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2021, 4, 17, 16, 2, 12, 856, DateTimeKind.Local).AddTicks(8637),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
