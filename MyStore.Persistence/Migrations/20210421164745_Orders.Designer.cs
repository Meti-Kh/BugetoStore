...
namespace MyStore.Persistence.Migrations
{
    ...
    [Migration("20210421164745_Orders")]
            ...
            modelBuilder.Entity("MyStore.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2021, 4, 21, 21, 17, 44, 576, DateTimeKind.Local).AddTicks(9010),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2021, 4, 21, 21, 17, 44, 581, DateTimeKind.Local).AddTicks(8154),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2021, 4, 21, 21, 17, 44, 581, DateTimeKind.Local).AddTicks(8355),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
