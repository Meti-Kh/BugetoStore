...
namespace MyStore.Persistence.Migrations
{
    ...
    [Migration("20210421171642_ReOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyStore.Domain.Entities.Cart.CartItams", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MyStore.Domain.Entities.Fience.RequestPay", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MyStore.Domain.Entities.HomePage.HomePageImages", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MyStore.Domain.Entities.Order.OrderDetail", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("MyStore.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            InsertTime = new DateTime(2021, 4, 21, 21, 46, 41, 632, DateTimeKind.Local).AddTicks(1027),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            ID = 2,
                            InsertTime = new DateTime(2021, 4, 21, 21, 46, 41, 637, DateTimeKind.Local).AddTicks(900),
                            IsRemoved = false,
                            Name = "Operator"
                        },
                        new
                        {
                            ID = 3,
                            InsertTime = new DateTime(2021, 4, 21, 21, 46, 41, 637, DateTimeKind.Local).AddTicks(1101),
                            IsRemoved = false,
                            Name = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("MyStore.Domain.Entities.Order.Order", b =>
                {
                    b.HasOne("MyStore.Domain.Entities.Fience.RequestPay", "RequestPay")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("MyStore.Domain.Entities.Order.OrderDetail", b =>
                {
                    b.HasOne("MyStore.Domain.Entities.Order.Order", "Order")
